...
void setup(){
    ...
    pinMode(morseAudPin,OUTPUT);
    delay(3000); //u got 3sec to upload and open Serial COM
    
    Serial.println("");
    Serial.println("  __  __  ___           _   ___ ___  ");
    Serial.println(" |  \\/  |/ __|  ___    /_\\ | __| __| ");
    Serial.println(" | |\\/| | (__  |___|  / _ \\|__ \\__ \\ ");
    Serial.println(" |_|  |_|\\___|       /_/ \\_\\___/___/ ");
    Serial.println("                                     ");
    Serial.println("");
    ...
    //setting custom aud Freq
    Serial.print("Enter Your Custom Audio Frequency (in 10sec): ");
    coustomAF = Serial.readString();
    if(coustomAF != ""){
        audFreq = coustomAF.toInt();
        Serial.println(coustomAF);
        delay(250);
        Serial.println("");
    }else{
        Serial.println("");
        Serial.println("Skipping The Custom Audio Frequency, Initializing Built-in Audio Frequency");
        delay(250);
        Serial.println("");
    }
